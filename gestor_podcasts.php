...
<head>
    ...
    <title>Activa El Turismo | Gestor de Podcasts</title>
...
<body>
    ...
    <main>
        <section class="hero">
            <h1>Gestor de Podcasts</h1>
            <p>Edita o elimina los podcasts publicados en el portal.</p>
        </section>
        ...
        <section class="panel-form-section">
            ...
            <div class="panel-form-card gestor-container">
                ...
                <div id="gestor-news-list" style="overflow-x: auto;">
                    <table class="news-table">
                        ...
                        <tbody id="gestor-podcasts-tbody">
                            <tr>
                                <td colspan="4" style="text-align: center; padding: 20px;">Cargando podcasts...</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="panel-form-card gestor-container" id="edit-modal">
                ...
                <form class="article-form-prototype" id="edit-podcast-form" action="editar_podcast.php" method="POST">
                    ...
                    <div class="form-grid">
                        ...
                        <label class="form-field form-field-full">
                            <span>Título</span>
                            <input type="text" name="titulo" id="edit-titulo" placeholder="Título del podcast" required>
                        </label>
                        <label class="form-field form-field-full">
                            <span>Descripción</span>
                            <textarea name="descripcion" id="edit-descripcion" rows="4" placeholder="Descripción del podcast"></textarea>
                        </label>
                    </div>
    ...
    <script src="js/gestor_podcasts.js?v=2"></script>
</body>
</html>
